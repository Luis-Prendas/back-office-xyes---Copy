...
import { useGetGameRecordByUserFilters } from '@/hooks/useGetGameRecord';
...
export default function TableGameRecordByUser({ userId }: Props) {
    ...
    const { data, refetch, isLoading } = useGetGameRecordByUserFilters(userId, JSON.stringify(formValues))
