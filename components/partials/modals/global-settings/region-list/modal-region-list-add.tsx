...
export default function ModalRegionListAdd({ showModal, handleModal, onSubmit }: Props) {
            ...
            <form onSubmit={onSubmit} className="bg-white rounded-lg w-[700px]">
                ...
                <section className="w-full p-4 flex flex-col gap-4 justify-center items-center">
                    <article className='flex w-full justify-center items-center gap-4'>
                        ...
                        <div className='w-3/5'>
                            <input className='form-input' type="text" id='countryOrRegion' name='countryOrRegion' />
                        </div>
                    </article>
                    <article className='flex w-full justify-center items-center gap-4'>
                        <span className='w-1/5 text-right'>{t('regionCode')}</span>
                        <div className='w-3/5'>
                            <input className='form-input' type="text" id='regionCode' name='regionCode' />
                        </div>
                    </article>
                    <article className='flex w-full justify-center items-center gap-4'>
                        <span className='w-1/5 text-right'>{t('flagURL')}</span>
                        <div className='w-3/5'>
                            <input className='form-input' type="text" id='flagURL' name='flagURL' />
                        </div>
                    </article>
                    <article className='flex w-full justify-center items-center gap-4'>
                        <span className='w-1/5 text-right'>{t('currencyName')}</span>
                        <div className='w-3/5'>
                            <input className='form-input' type="text" id='currencyName' name='currencyName' />
                        </div>
                    </article>
                    <article className='flex w-full justify-center items-center gap-4'>
                        <span className='w-1/5 text-right'>{t('currencyCode')}</span>
                        <div className='w-3/5'>
                            <input className='form-input' type="text" id='currencyCode' name='currencyCode' />
                        </div>
                    </article>
                    <article className='flex w-full justify-center items-center gap-4'>
                        <span className='w-1/5 text-right'>{t('sorted')}</span>
                        <div className='w-3/5'>
                            <input className='form-input' type="text" id='sorted' name='sorted' />
                        </div>
                    </article>
                </section>
