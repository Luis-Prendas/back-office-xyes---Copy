...
export default function Filters({ children, handleSubmit, changeTime, changeUsd }: Props) {
    ...
    return (
        <form onSubmit={handleSubmit} className="grid grid-cols-6 grid-rows-1 gap-4">
            <div className="col-span-2 row-span-1 flex h-full w-full items-start justify-start rounded border border-gray-400 p-2">
            ...
            <div className="col-span-2 row-span-1 flex h-full w-full flex-col items-start justify-between gap-4 rounded border border-gray-400 p-2">
